  ...
  return (
    <section className="footer">
      ...
      <div className="footer-items">
        <button className="btn" onClick={handleAboutClickScroll}>
          About
        </button>
        <button className="btn" onClick={handleProjectClickScroll}>
          Projects
        </button>
        <button className="btn" onClick={handleHomeClickScroll}>
          Home
        </button>
      </div>
    </section>
